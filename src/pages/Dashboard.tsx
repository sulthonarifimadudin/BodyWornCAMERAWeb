...
const Dashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground transition-colors duration-300 flex overflow-x-hidden relative">
      ...
      <aside
        className={cn(
          "fixed top-0 left-0 z-50 w-[260px] h-screen bg-card/95 backdrop-blur-xl border-r border-border/50 flex flex-col shadow-2xl transition-all duration-300 sidebar-dark",
