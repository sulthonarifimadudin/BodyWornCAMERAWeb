    ...
    <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
      {stats.map((stat, i) => (
        <motion.div
          ...
          className="bg-cyan-500 border-cyan-600 dark:bg-cyan-700 dark:border-cyan-600 rounded-xl p-3 sm:p-4 shadow-md border transition-all hover:shadow-lg text-white"
        >
          <div className="flex items-start justify-between gap-2">
            ...
            <div className="w-8 h-8 sm:w-10 sm:h-10 shrink-0 rounded-lg flex items-center justify-center bg-white/20">
