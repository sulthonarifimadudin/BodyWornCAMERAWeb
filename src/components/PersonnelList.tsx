...
interface PersonnelListProps {
  ...
  onSendAlert?: (userId: string, action: 'start' | 'stop') => void;
}
  ...
  return (
    <div className="relative h-full">
      <motion.div
        ...
        className="glass-card rounded-xl h-full flex flex-col shadow-[0_2px_10px_rgba(0,0,0,0.1)]"
      >
        ...
        <div className="flex-1 overflow-y-auto p-2 space-y-2">
          ...
          {personnel.map((person, i) => (
            <motion.div
              ...
              className={cn(
                "p-3 rounded-lg cursor-pointer transition-all duration-200 border group relative",
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="relative">
                  ...
                  <span className={cn(
                    ...
                    person.status === "online" && "bg-success shadow-[0_0_8px_hsl(var(--success)/0.5)]",
                    person.status === "alert" && "bg-destructive animate-pulse shadow-[0_0_12px_hsl(var(--destructive)/0.5)]",
